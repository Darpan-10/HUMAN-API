        ...
        <div className="w-full max-w-2xl space-y-10 animate-fade-in">
          ...
          <div className="text-center space-y-4">
            ...
            <h1 className="font-display text-5xl sm:text-6xl font-black tracking-tight leading-none">
              ...
              <br />
              <span className="bg-gradient-to-r from-lime-600 to-yellow-500 bg-clip-text text-transparent">
                Perfect Match
              </span>
            </h1>
          ...
          <div className="space-y-5">
            <div className="relative">
              <Textarea
                ...
                className="min-h-[180px] text-base resize-none rounded-2xl border-2 border-green-200 focus:border-green-500 focus:ring-0 bg-white/80 backdrop-blur-xl placeholder-gray-400 font-medium transition-all duration-300"
              />
            ...
            <Button
              ...
              className="w-full py-7 text-lg font-display font-bold gap-3 rounded-2xl bg-gradient-to-r from-green-600 to-yellow-600 hover:from-green-700 hover:to-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-2xl transition-all duration-300"
            >
              {loading ? (
                <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <button
                  ...
                  className="p-4 text-left rounded-xl bg-white/60 hover:bg-white border border-green-100 hover:border-green-300 transition-all duration-300 hover:shadow-md group"
                >
                  <p className="text-sm text-gray-700 font-medium group-hover:text-green-600 transition-colors line-clamp-2">
                    {example}
                  </p>
                </button>
              ))}
