    ...
    <div className="min-h-screen flex flex-col overflow-hidden">
      ...
      <nav className="relative px-6 py-6 flex items-center justify-between max-w-6xl mx-auto w-full">
        ...
        <Button
          ...
          className="gap-2 font-semibold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition-all"
        >
      ...
      {/* Main content */}
      <main className="relative flex-1 px-6 py-8 max-w-5xl mx-auto w-full overflow-y-auto">
        <div className="space-y-10 animate-fade-in pb-12">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-lg text-gray-600 font-medium">
              {results && results.length > 0
                ? `Found ${results.length} great match${results.length !== 1 ? 'es' : ''} for you`
          ...
          {!results || results.length === 0 ? (
            <div className="text-center py-20 space-y-6">
              <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center mx-auto">
              ...
              <Button
                onClick={() => navigate("/intent")}
                className="gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg"
              >
